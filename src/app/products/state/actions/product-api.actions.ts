...
export const loadProductsFailure = createAction('[Product API] Load Products Failed', props<{ error: string }>());

export const updateProductSuccess = createAction('[Product API] Update Product SUccess', props<{ product: Product }>());

export const updateProductFailure = createAction('[Product API] Update Product Failed', props<{ error: string }>());

export const createProductSuccess = createAction('[Product API] Create Product SUccess', props<{ product: Product }>());

export const createProductFailure = createAction('[Product API] Create Product Failed', props<{ error: string }>());

export const deleteProductSuccess = createAction('[Product API] Delete Product SUccess', props<{ id: number }>());

export const deleteProductFailure = createAction('[Product API] Delete Product Failed', props<{ error: string }>());